...
set MAIN_JAR=dcm4che-tool-wadows-5.33.1.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-mime-5.33.1.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-tool-common-5.33.1.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-xdsi-5.33.1.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\jaxb-runtime-4.0.4.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\jaxb-core-4.0.4.jar
