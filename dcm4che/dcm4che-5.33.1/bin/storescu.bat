...
set MAIN_JAR=dcm4che-tool-storescu-5.33.1.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-image-5.33.1.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-imageio-5.33.1.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-imageio-opencv-5.33.1.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-imageio-rle-5.33.1.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-tool-common-5.33.1.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\weasis-core-img-4.9.0.1.jar
